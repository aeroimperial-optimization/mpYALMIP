function diagnostic = solvesdp_SDPAgmp(varargin)
...
options.solver = 'sdpa';                    % overwrite solver to SDPA
...
% ******************************************
[interfacedata,recoverdata,solver,diagnostic,F,Fremoved,ForiginalQuadratics] = compileinterfacedata_SDPAgmp(F,[],logdetStruct,h,options,0,solving_parametric);
