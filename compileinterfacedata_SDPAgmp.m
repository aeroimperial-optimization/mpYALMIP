function [interfacedata,recoverdata,solver,diagnostic,F,Fremoved,ForiginalQuadratics] = compileinterfacedata_SDPAgmp(F,aux_obsolete,logdetStruct,h,options,findallsolvers,parametric)
...
% gf on 5/7/2016: for YALMIP version 2015-09-19 uncomment the second line
...
[ProblemClass,integer_variables,binary_variables,parametric_variables,uncertain_variables,semicont_variables,quad_info] = categorizeproblem(F,logdetStruct,h,options.relax,parametric,evaluation_based,F_vars,0);
...
if strcmp(solver.tag,'SDPA'); solver.call = 'callsdpagmp';end               % ADDED BY GF910 ON 01/08/2015
if isempty(solver)
    diagnostic.solvertime = 0;
